...
CREATE TABLE `user` (
  ...
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`addressID`) REFERENCES `address_info` (`addressID`)
...
CREATE TABLE `user_books` (
  ...
  CONSTRAINT `user_books_ibfk_3` FOREIGN KEY (`addressID`) REFERENCES `address_info` (`addressID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-03 16:22:17
